...
<ArticleImage src="/static/images/blog/build-in-public/chrome-devtools-network-panel.png" alt="Chrome DevTools Network tab showing HTTP fetch requests, status codes, and timing waterfalls." />
...
<ArticleImage src="/static/images/blog/build-in-public/chrome-devtools-heap-snapshot.png" alt="Chrome DevTools Heap Snapshot comparison showing memory growing from 32MB to 148MB due to detached HTMLDivElements." />
