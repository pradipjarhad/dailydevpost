...
date: 2026-01-11
slug: "what-actually-caused-unnecessary-re-renders"
...
faqs:
  - question: "Why does my React component re-render when nothing changed?"
    answer: >-
      Usually, it's because a prop reference changed, even if the value looks the same. Inline objects, arrays, or functions are recreated on every parent render, triggering the child to update.
  - question: "Does every re-render matter for app performance?"
    answer: >-
      No. React is very fast at small re-renders. You only need to optimize when a large component tree is updating frequently or when you notice visible lag in the user interface.
  - question: "How does Context API affect re-render performance?"
    answer: >-
      When a Context value changes, EVERY component consuming that context re-renders. If your context holds frequently changing data, it can cause significant performance bottlenecks.
  - question: "How can I debug which prop is causing a re-render?"
    answer: >-
      Use the React DevTools Profiler. It can show you exactly which component rendered, how long it took, and which specific prop change triggered the render.
thumbnailAlt: "Detailed visual guide and illustration for What Actually Caused Unnecessary Re-renders (In My Experience), focusing on Build In Public, Modern React best practices and tutorials."
---
...
Just inefficient. (Kind of like [this bug I tracked down recently](/blog/a-bug-i-recently-faced-and-how-i-actually-tracked-it-down)).
...
Splitting state into smaller, focused pieces reduced re-renders more than any memoization trick I tried later. (I wrote more about [removing state here](/blog/the-time-i-removed-state-instead-of-adding-more)).
...
If you are wondering how to fix these issues, I wrote about [how I actually reduced unnecessary re-renders](/blog/how-i-actually-reduced-unnecessary-re-renders) in a follow-up post.
