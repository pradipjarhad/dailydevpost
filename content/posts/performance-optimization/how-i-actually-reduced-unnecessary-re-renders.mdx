...
date: 2026-01-13
slug: "performance-optimization/how-i-actually-reduced-unnecessary-re-renders"
...
In my previous post, I talked about the [things that caused unnecessary re-renders](/blog/performance-optimization/what-actually-caused-unnecessary-re-renders) in my apps.
...
Before talking about solutions, one [mindset shift](/blog/frontend-engineering/one-mental-model-that-made-react-easier-for-me) mattered more than any code change.
