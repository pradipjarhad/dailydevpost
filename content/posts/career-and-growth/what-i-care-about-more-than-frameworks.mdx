...
date: 2026-01-04
slug: "career-and-growth/what-i-care-about-more-than-frameworks"
...
If the code is obvious (like I discussed in [this habit](/blog/tooling-and-dx/one-habit-that-made-my-code-easier-to-read)), even if it’s longer, that’s a win.
...
[Complex mental models](/blog/frontend-engineering/one-mental-model-that-made-react-easier-for-me) are expensive.
