...
date: 2026-01-29
slug: "build-in-public/one-habit-that-made-my-code-easier-to-read"
...
- The [naming was unclear](/blog/build-in-public/why-naming-is-harder-than-logic-in-frontend-code) or misleading  
...
That pause is the habit. (I'm trying to improve [another React habit next week](/blog/build-in-public/one-react-habit-i-want-to-improve-next-week)).
