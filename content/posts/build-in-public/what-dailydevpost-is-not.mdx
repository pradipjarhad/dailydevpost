...
**DailyDevPost shows the messy middle.** (Like [what debugging taught me that tutorials didn't](/blog/build-in-public/what-debugging-taught-me-that-tutorials-didnt)).
