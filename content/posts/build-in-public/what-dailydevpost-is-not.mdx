...
(You can read more about [why I decided to start this](/blog/build-in-public/why-i-decided-to-learn-in-public-now) in my first post).
...
**DailyDevPost shows the messy middle.** (Like [what debugging taught me that tutorials didn't](/blog/debugging-and-fixes/what-debugging-taught-me-that-tutorials-didnt)).
