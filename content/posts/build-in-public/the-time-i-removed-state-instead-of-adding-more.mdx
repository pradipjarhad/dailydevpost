...
date: 2026-01-10
slug: "build-in-public/data/blog/dev-diary/the-time-i-removed-state-instead-of-adding-more"
...
Something didn’t [re-render correctly](/blog/build-in-public/what-actually-caused-unnecessary-re-renders)?    
Add state.
