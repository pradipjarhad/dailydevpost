...
date: 2026-01-11
slug: "dev-diary/what-actually-caused-unnecessary-re-renders"
tags: ['dev-diary','react']
thumbnail: '/static/images/blog/dev-diary/what-actually-caused-unnecessary-re-renders.png'
draft: false
...
Only later, when the app grew a bit, when components became heavier, and when interactions started feeling slightly sluggish, I realized something was off. Not broken. Just inefficient.
...
Splitting state into smaller, focused pieces reduced re-renders more than any memoization trick I tried later.
