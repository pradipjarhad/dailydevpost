...
faqs:
  - question: "Do you need to be an expert to learn in public?"
    answer: >-
      No. Learn in public is actually more valuable when you aren't an expert. It's about capturing fresh realizations before they start feeling 'obvious' or vanish from memory.
  - question: "Is learning in public the same as teaching?"
    answer: >-
      No, it's about keeping a record of your journey. It's admiting confusion and sharing mistakes as much as it is sharing solutions and successes.
  ...
  - question: "How does writing help with learning technical concepts?"
    answer: >-
      Writing forces you to explain things to yourself first, which exposes gaps in your understanding and makes the sticky points of a new concept visible.
thumbnailAlt: "Detailed visual guide and illustration for Why I Decided to Learn in Public Now (And Not Earlier), focusing on Build In Public best practices and tutorials."
---
...
You forget:
- Why something was confusing (I wrote that one [here](/blog/why-i-chose-this-tech-stack-for-my-developer-blog))  
...
- [Small React learnings](/blog/how-i-really-learn-react-concepts)  
- [Debugging stories](/blog/the-one-debugging-habit-that-saves-me-hours-every-week)  
...
(This is exactly [what DailyDevPost is not](/blog/what-dailydevpost-is-not): a tutorial site).
...
- Sound like an expert (I wrote exactly [where I am right now here](/blog/where-i-am-right-now-as-a-frontend-developer))  
