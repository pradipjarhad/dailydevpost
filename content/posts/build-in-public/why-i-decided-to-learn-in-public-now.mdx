...
date: 2025-12-30
slug: "build-in-public/why-i-decided-to-learn-in-public-now"
...
You forget:
- Why something was confusing (I wrote that one [here](/blog/build-in-public/why-i-chose-this-tech-stack-for-my-developer-blog))  
...
- [Small React learnings](/blog/frontend-engineering/how-i-really-learn-react-concepts)  
- [Debugging stories](/blog/debugging-and-fixes/the-one-debugging-habit-that-saves-me-hours-every-week)  
...
(This is exactly [what DailyDevPost is not](/blog/build-in-public/what-dailydevpost-is-not): a tutorial site).
...
- Sound like an expert (I wrote exactly [where I am right now here](/blog/career-and-growth/where-i-am-right-now-as-a-frontend-developer))  
...
- [**Build in Public**](/blog/build-in-public) – The raw journey of building this site.
- [**AI for Developers**](/blog/ai-for-developers) – Integrating AI into the creative workflow.
- [**JavaScript Deep Dives**](/blog/javascript-deep-dives) – Getting under the hood of the language.
- [**Frontend Engineering**](/blog/frontend-engineering) – Building better interfaces.
- [**Performance Optimization**](/blog/performance-optimization) – Making things fast and efficient.
- [**Tooling & DX**](/blog/tooling-and-dx) – Improving how we work.
- [**Debugging & Fixes**](/blog/debugging-and-fixes) – Real problems, real solutions.
- [**Career & Growth**](/blog/career-and-growth) – The human side of being a developer.
