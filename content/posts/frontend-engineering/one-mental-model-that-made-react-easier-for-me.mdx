...
faqs:
  - question: "What is the core React mental model described here?"
    answer: >-
      React is just a function that turns state and props into UI. This 'Input -> Output' model simplifies everything from rendering to debugging.
  - question: "Why is thinking of components as 'passive' helpful?"
    answer: >-
      When components are passive descriptions of UI, you stop trying to 'control' them with complex effects. You focus on managing the data (state), and let React handle the updates.
  - question: "How does this mental model change how you view re-renders?"
    answer: >-
      Re-renders stop being scary 'glitches' and become simple recalculations. If the UI is wrong, it's a data problem, not a rendering error.
  - question: "Should I use useEffect to force UI updates?"
    answer: >-
      No. According to this model, UI updates should be a natural consequence of state changes. Use 'useEffect' only to sync with external systems outside of React's control.
...
This guide is a core part of our [Frontend Development Roadmap 2026](/blog/frontend-development-roadmap-2026), serving as a deep dive into React mental models and state management.
...
Earlier, I used [useEffect like a fix-all](/blog/one-mistake-i-made-with-useeffect-and-how-i-think-about-it-now).
...
When I learn something new in React now (which is [a messy process](/blog/how-i-really-learn-react-concepts)), I filter it through this model.
