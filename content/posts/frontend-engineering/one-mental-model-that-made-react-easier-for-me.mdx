...
date: 2026-01-15
slug: "frontend-engineering/one-mental-model-that-made-react-easier-for-me"
...
Earlier, I used [useEffect like a fix-all](/blog/frontend-engineering/one-mistake-i-made-with-useEffect-and-how-i-think-about-it-now).
...
When I learn something new in React now (which is [a messy process](/blog/frontend-engineering/how-i-really-learn-react-concepts)), I filter it through this model.
