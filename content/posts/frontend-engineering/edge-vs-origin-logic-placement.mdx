...
2.  **Large Dependency Trees**: If your logic requires a 10MB PDF generation library or a heavy image processing SDK, keep it at the Origin. [Edge cold starts](/blog/edge-performance-cold-starts-guide) are highly sensitive to bundle size.
